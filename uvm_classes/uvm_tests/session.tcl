...
gui_sg_addsignal -group "$_session_group_1" { {source_h_uvm_sequence_item} }   -objtype stream 
gui_list_add_group -id ${Wave.1} -after {New Group} {transaction}
gui_list_set_height -id ${Wave.1} -height 79  -name V1:source_h_uvm_sequence_item -occurrence 1 -group ${transaction} 
