...
gui_sg_addsignal -group "$_session_group_1" { {uvm_test_top$env_h$agent_h$sequencer_h}
                                              ...
                                              {uvm_test_top_env_h_agent_h_monitor_h_tr}
...
gui_list_set_height -id ${Wave.1} -height 80  -name {V1:uvm_test_top_env_h_agent_h_monitor_h_tr} -occurrence 1 -group ${transaction}
