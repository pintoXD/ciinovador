...
gui_sg_addsignal -group "$_session_group_1" { {uvm_test_top_env_h_agent_h_source_h_tr} {uvm_test_top_env_h_refmod_h_tr_out} }   -objtype stream
gui_list_add_group -id ${Wave.1} -after {New Group} {transaction}
gui_list_set_height -id ${Wave.1} -height 80  -name {V1:uvm_test_top_env_h_agent_h_source_h_tr} -occurrence 1 -group ${transaction}
