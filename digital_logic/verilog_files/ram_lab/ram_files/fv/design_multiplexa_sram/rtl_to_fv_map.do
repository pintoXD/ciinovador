...
# Generated on: Thu Dec 05 09:57:12 -03 2024 (Thu Dec 05 12:57:12 UTC 2024)
...
set_log_file fv/design_multiplexa_sram/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/design_multiplexa_sram -revised fv_map
...
add_notranslate_modules -library -both SPRAM256X8

add_search_path . /home/tools/cadence/installs/GENUS211/tools.lnx86/lib/tech -library -both
read_library -liberty -both /home/cinovador/Downloads/sram_aula/SPRAM256X8.lib /home/cinovador/Downloads/sram_aula/fast_vdd1v0_basicCells_hvt.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  design_multiplexa_sram.sv
elaborate_design -golden -root {design_multiplexa_sram} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/design_multiplexa_sram/fv_map.v.gz
elaborate_design -revised -root {design_multiplexa_sram}
...
#add_name_alias fv/design_multiplexa_sram/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/design_multiplexa_sram/rtl_to_fv_map.log
}
