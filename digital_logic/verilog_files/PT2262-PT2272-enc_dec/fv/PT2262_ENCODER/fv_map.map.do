...
//Sequential Pins
add mapped point bit_gen_input[1]/q bit_gen_input_reg[1]/Q  -type DLAT DLAT
add mapped point bit_gen_input[1]/q bit_gen_input_reg[1]/QN  -type DLAT DLAT
add mapped point bit_gen_rst/q bit_gen_rst_reg/Q  -type DLAT DLAT
add mapped point bit_gen_rst/q bit_gen_rst_reg/QN  -type DLAT DLAT
add mapped point past_osc_clk/q past_osc_clk_reg/Q  -type DFF DFF
add mapped point bit_gen_enb/q bit_gen_enb_reg/Q  -type DLAT DLAT
add mapped point bit_gen_enb/q bit_gen_enb_reg/QN  -type DLAT DLAT
add mapped point bit_gen_input[0]/q bit_gen_input_reg[0]/Q  -type DLAT DLAT
add mapped point bit_gen_input[0]/q bit_gen_input_reg[0]/QN  -type DLAT DLAT
...
add mapped point signal_creator/bit_sent/q signal_creator_bit_sent_reg/Q  -type DLAT DLAT
add mapped point signal_creator/bit_sent/q signal_creator_bit_sent_reg/QN  -type DLAT DLAT
...
add mapped point addr_interpreter addr_interpreter -type BBOX BBOX
