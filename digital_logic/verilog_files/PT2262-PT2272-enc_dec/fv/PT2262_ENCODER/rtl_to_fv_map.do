...
# Generated on: Fri Dec 20 13:22:45 -03 2024 (Fri Dec 20 16:22:45 UTC 2024)
...
set_log_file fv/PT2262_ENCODER/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/PT2262_ENCODER -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  encoder/codificador_pt2262.sv bit_gen/bit_generator.sv oscillator/clock_divider.sv
elaborate_design -golden -root {PT2262_ENCODER} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/PT2262_ENCODER/fv_map.v.gz
elaborate_design -revised -root {PT2262_ENCODER}
...
#add_name_alias fv/PT2262_ENCODER/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box ADDRESS_INTERPRETER -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/PT2262_ENCODER/rtl_to_fv_map.log
}
