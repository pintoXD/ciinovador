...
# Generated on: Fri Dec 20 14:47:23 -03 2024 (Fri Dec 20 17:47:23 UTC 2024)
...
set_log_file fv/CLOCK_DIVIDER/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/CLOCK_DIVIDER -revised fv_map
...
read_library -liberty -both /home/cinovador/Documents/course_files/digital_logic/verilog_files/PT2262-PT2272-enc_dec/libs/fast_vdd1v2_basicCells.lib
...
read_design -verilog95   -revised -lastmod -noelab fv/CLOCK_DIVIDER/fv_map.v.gz
elaborate_design -revised -root {CLOCK_DIVIDER}
...
#add_name_alias fv/CLOCK_DIVIDER/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/CLOCK_DIVIDER/rtl_to_fv_map.log
}
