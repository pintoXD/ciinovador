...
# Generated on: Mon Jan 13 09:16:36 -03 2025 (Mon Jan 13 12:16:36 UTC 2025)
...
set_log_file fv/decodificador_pt2272/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/decodificador_pt2272 -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/cinovador/Documents/course_files/digital_logic/verilog_files/PT2262-PT2272-enc_dec/decoder/decodificador_pt2272.sv /home/cinovador/Documents/course_files/digital_logic/verilog_files/PT2262-PT2272-enc_dec/oscillator/clock_divider.sv /home/cinovador/Documents/course_files/digital_logic/verilog_files/PT2262-PT2272-enc_dec/addr_interpreter/addr_interpreter.sv /home/cinovador/Documents/course_files/digital_logic/verilog_files/PT2262-PT2272-enc_dec/bidir_shift_register/bidir_shiftreg.sv
elaborate_design -golden -root {decodificador_pt2272} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/decodificador_pt2272/fv_map.v.gz
elaborate_design -revised -root {decodificador_pt2272}
...
#add_name_alias fv/decodificador_pt2272/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box comp_endereco -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/decodificador_pt2272/rtl_to_fv_map.log
}
