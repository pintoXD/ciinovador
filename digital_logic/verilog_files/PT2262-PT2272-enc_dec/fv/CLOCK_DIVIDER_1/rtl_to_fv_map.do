...
# Generated on: Fri Dec 20 14:44:52 -03 2024 (Fri Dec 20 17:44:52 UTC 2024)
...
set_log_file fv/CLOCK_DIVIDER_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/CLOCK_DIVIDER_1 -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  oscillator/clock_divider.sv
elaborate_design -golden -root {CLOCK_DIVIDER} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/CLOCK_DIVIDER_1/fv_map.v.gz
elaborate_design -revised -root {CLOCK_DIVIDER_1}
...
#add_name_alias fv/CLOCK_DIVIDER_1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/CLOCK_DIVIDER_1/rtl_to_fv_map.log
}
