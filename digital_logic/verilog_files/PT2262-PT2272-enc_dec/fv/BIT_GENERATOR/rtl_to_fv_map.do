...
# Generated on: Fri Dec 20 16:45:09 -03 2024 (Fri Dec 20 19:45:09 UTC 2024)
...
set_log_file fv/BIT_GENERATOR/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/BIT_GENERATOR -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  bit_gen/bit_generator.sv
elaborate_design -golden -root {BIT_GENERATOR} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/BIT_GENERATOR/fv_map.v.gz
elaborate_design -revised -root {BIT_GENERATOR}
...
#add_name_alias fv/BIT_GENERATOR/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/BIT_GENERATOR/rtl_to_fv_map.log
}
