...
# Generated on: Fri Feb 21 13:00:13 -03 2025 (Fri Feb 21 16:00:13 UTC 2025)
...
set_log_file fv/ieee754multiplier/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ieee754multiplier -revised fv_map
...
add_search_path /home/cinovador/Documents/course_files/physical_synthesis/synthesis/backend/synthesis/deliverables /home/cinovador/Documents/course_files/physical_synthesis/synthesis/frontend -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/cinovador/Documents/course_files/physical_synthesis/synthesis/frontend/ieee754multiplier.sv
elaborate_design -golden -root {ieee754multiplier} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ieee754multiplier/fv_map.v.gz
elaborate_design -revised -root {ieee754multiplier}
...
#add_name_alias fv/ieee754multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/ieee754multiplier/rtl_to_fv_map.log
}
