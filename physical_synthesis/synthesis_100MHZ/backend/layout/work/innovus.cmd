...
#  Created on Thu Feb 27 19:17:04 2025                
#                                                     
#######################################################
...
#@ source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/layout.tcl
#@ Begin verbose source (pre): source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/layout.tcl
...
set period_clk 10.0  ;
set clk_uncertainty 0.044 ;
set clk_latency 0.105 ;
set in_delay 0.28 ;
set out_delay 0.35;
set out_load 0.045 ;
...
#@ Begin verbose source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/synthesis/scripts/common/path.tcl (pre)
...
#@ Begin verbose source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/multiplier32FP.view (pre)
...
#@ End verbose source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/multiplier32FP.view
...
#@ Begin verbose source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/cts.ccopt (pre)
...
#@ End verbose source /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/cts.ccopt
...
get_db power_method ;
report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_100MHZ_no_VCD.rpt
set_db power_corner min
read_activity_file -format VCD -scope ${DESIGNS}_tb/DUT ${PROJECT_DIR}/frontend/work/${DESIGNS}_MAX_tb.vcd
report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_100MHZ_VCD_MAX.rpt
read_activity_file -format VCD -scope ${DESIGNS}_tb/DUT ${PROJECT_DIR}/frontend/work/${DESIGNS}_MIN_tb.vcd -reset
report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_100MHZ_VCD_MIN.rpt
report_area > ${BACKEND_DIR}/layout/deliverables/reports/power_report_100MHZ_area.rpt
report_timing > ${BACKEND_DIR}/layout/deliverables/reports/power_report_100MHZ_timing.rpt
...
#@ End verbose source: /home/cinovador/Documents/course_files/physical_synthesis/synthesis_100MHZ/backend/layout/scripts/layout.tcl
exit
