...
if [ $1 == "-genus" ]; then
    ...
    # genus -abort_on_error \
    #     -lic_startup Genus_Synthesis -lic_startup_options Genus_Physical_Opt \
    #     -log ${BACKEND_DIR}/synthesis/work/genus/genus \
    #     -overwrite -files ${PROJECT_DIR}/backend/synthesis/scripts/${DESIGNS}.tcl
    genus -lic_startup Genus_Synthesis -lic_startup_options Genus_Physical_Opt \
         -log ${BACKEND_DIR}/synthesis/work/genus/genus \
         -overwrite -files ${PROJECT_DIR}/backend/synthesis/scripts/${DESIGNS}.tcl
fi
