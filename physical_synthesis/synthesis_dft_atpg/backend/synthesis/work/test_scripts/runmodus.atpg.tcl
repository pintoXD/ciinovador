...
build_model \
    ...
    -designsource	 $WORKDIR/multiplier32FP.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/multiplier32FP.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 multiplier32FP_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_multiplier32FP_atpg
...
check_log log_write_vectors_FULLSCAN_multiplier32FP_atpg
...
check_log log_commit_tests_FULLSCAN_multiplier32FP_atpg
