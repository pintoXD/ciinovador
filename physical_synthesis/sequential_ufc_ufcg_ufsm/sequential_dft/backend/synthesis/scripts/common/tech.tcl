...
# No scan flip-flops
#get_db base_cell:CKLHQD20BWP30P140 .dont_use
#set_db base_cell:CKLHQD20BWP30P140 .dont_use false
#get_db base_cells CKL*
#get_db base_cell:CKLHQD24BWP30P140 .dont_use
#foreach lc [get_db base_cells -if {.dont_use == true && .name == "CKL*"}] {
#  get_db $lc .dont_use
#  set_db $lc .dont_use false
#}
