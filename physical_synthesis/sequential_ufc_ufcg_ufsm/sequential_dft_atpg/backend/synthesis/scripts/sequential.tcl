...
write_sdc > ${DEV_DIR}/${HDL_NAME}.sdc
...
write_sdf -edge check_edge -setuphold merge_always -nonegchecks -recrem split -version 3.0 -design ${HDL_NAME} > ${DEV_DIR}/${HDL_NAME}_dft_delays.sdf
write_hdl ${HDL_NAME} > ${DEV_DIR}/${HDL_NAME}_dft.v
write_sdc > ${DEV_DIR}/${HDL_NAME}_dft.sdc
write_scandef > ${DEV_DIR}/${HDL_NAME}.scandef
write_dft_atpg -library ${LIB_SRC}/slow_vdd1v0_basicCells.v
