...
# #
# read_activity_file -format VCD -scope somador_tb(verification)/DUV ${FRONTEND_DIR}/work/${DESIGNS}_layout_10kns.vcd
# report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_VCD_10kns.rpt
# #
# read_activity_file -format VCD -scope somador_tb(verification)/DUV ${FRONTEND_DIR}/work/${DESIGNS}_layout_5kns.vcd -reset
# report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_VCD_5kns.rpt



# #
# read_activity_file -format VCD -scope somador_tb(verification)/DUV ${FRONTEND_DIR}/work/${DESIGNS}_layout_10kns_minimum.vcd -reset
# report_power -power_unit uW > ${BACKEND_DIR}/layout/deliverables/reports/power_report_VCD_10kns_minimum.rpt
# #
# read_activity_file -format VCD -scope somador_tb(verification)/DUV ${FRONTEND_DIR}/work/${DESIGNS}_layout_5kns_minimum.vcd -reset
